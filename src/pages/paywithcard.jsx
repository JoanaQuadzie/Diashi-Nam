...
import Creditcard2 from "../assets/images/creditcard2.jpg";

export default function paywithcard() {
  return (
    <div>
      <h1 className="text-primary text-5xl font-bold text-center py-14">
        Enter Card Details
      </h1>
      <div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
          ...
          <form>
            ...
            <div class="mt-8">
              <button
                type="submit"
                class="w-full bg-primary hover:bg-blue-600 text-white font-medium py-3 rounded-lg focus:outline-none"
              >
                Submit
              </button>
            </div>
