...
export default function profile() {
  return (
    ...
    <div>
      <section>
        <h1 className="text-6xl text-center text-green-600 font-bold pt-10">Profile</h1>
    <div class="container mx-auto  px-4 sm:px-6 lg:px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            <div class="max-w-lg">
                <h2 class="text-2xl font-extrabold text-green-700 sm:text-4xl">About Me</h2>
                <p class="mt-4 text-green-800 text-lg w-12/12">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis
                    eros at lacus feugiat hendrerit sed ut tortor.</p>
                    <button className="bg-green-700 text-yellow-400 hover:bg-green-800 font-bold border rounded-full py-2 px-8 mt-6">Select</button>
            </div>
  ...
  <div class="ml-6">
    <p class="flex items-baseline">
      <span class="text-gray-600 font-bold">Rexford</span>
    ...
    <div class="mt-3">
      <span class="font-bold text-green-800">Sapien consequat eleifend!</span>
